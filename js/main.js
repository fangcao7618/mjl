var jarallax;
	...
	$(function() {
		...
		jarallax.addAnimation('#chengbao',[
				{progress:'15%', display:'block', opacity:'1', top:'1450px'},
		...
		/*jarallax.addAnimation('#iphoneBG',[
				{progress:'83%', display:'block', opacity:'1', top:'4545px'},
				{progress:'84%', display:'block', opacity:'1', top:'4515px'},
				{progress:'85%', display:'block', opacity:'1', top:'4485px'},
				{progress:'100%', display:'block', opacity:'1', top:'4485px'}
		]);*/
      }