...
var iEnd = new Date().setTime(new Date().getTime() + 15 * 1000);
	...
	$("#sparks").click(function(){
			...
			paowu('<div id="ball1"></div>','ball1',500,700,100,150,15,"picList");/*+35-75*/
			 paowu('<div id="ball3"></div>','ball3',500,700,800,200,15,"picList");/*+35-75*/
			 
			 paowu('<div id="ball2"></div>','ball2',500,700,250,200,15,"picList");/*+35-75*/
			 paowu('<div id="ball4"></div>','ball4',500,700,630,300,15,"picList");/*+35-75*/
			 
			 paowu('<div id="ball5"></div>','ball5',500,700,230,400,15,"picList");/*+35-75*/
			 paowu('<div id="ball6"></div>','ball6',500,700,730,530,15,"picList");/*+35-75*/
			 
			 paowu('<div id="ball7"></div>','ball7',500,700,150,550,15,"picList");/*+35-75*/
			 paowu('<div id="ball8"></div>','ball8',500,700,850,400,15,"picList");/*+35-75*/
			 
			 paowu('<div id="ball9"></div>','ball9',500,700,30,380,15,"picList");/*+35-75*/
			 paowu('<div id="ball10"></div>','ball10',500,700,310,250,15,"picList");/*480+35-75  515*/
	});
