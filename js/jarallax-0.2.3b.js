...
Jarallax.prototype.setProgress = function (progress, isWeak) {
  ...
  if(this.progress != progress){
	...
	/*if(_scrollTop_wfc<=leftP && _scrollTop_wfc>lrightP){
		...
		if(_scrollTop_wfc<850 && _scrollTop_wfc>=770){
			if(!!$("#peoList div#xiang_du").length==false){
			paowu('<div id="xiang_du"></div>','xiang_du',525,600,70,300,15,"peoList");
			paowu('<div id="qinwang_du"></div>','qinwang_du',525,600,725,300,15,"peoList");	
			}
		}
