...
Jarallax.prototype.setProgress = function (progress, isWeak) {
  ...
  if(this.progress != progress){
	...
	//console.log("progress:"+(parseFloat(this.progress*1000)));
	//判断按钮是否出现
	var t = document.documentElement.scrollTop || document.body.scrollTop; //1752
		var _sparks=$("#sparks");
		var _html=$("html");
		var interval,leftP=325,lrightP=310;
	...
	if($.browser.mozilla===true){
		leftP=322;lrightP=320;//leftP=322;lrightP=320;
	}
	if($.browser.safari===true && $.browser.version==="537.1"){
		leftP=322;lrightP=320;//leftP=311;lrightP=310;	
	}
	if($.browser.version==="8.0" || $.browser.version==="7.0"){
		leftP=322;lrightP=320;	
	}
	//console.log("leftP:"+leftP+" lrightP:"+lrightP);
	/*if(_scrollTop_wfc<=leftP && _scrollTop_wfc>lrightP){
		$("#picList").empty();
		_html.css("overflow-y","hidden");
		_sparks.css({"display":"block"});
	}else{
		_sparks.css("display","none");
		_html.css("overflow-y","scroll");
	}*/
	if(_scrollTop_wfc<=500){
		if(_scrollTop_wfc>=300){//332   _scrollTop_wfc<=400 && _scrollTop_wfc>=330
		//console.log("进来了");
		$("#jiantou").css("display","block");
			if(!!$("#ball1").length==false){
				$("#sparks,#sparks02").hover(function(){
					$("#chengbao03").css("display","block");
				},function(){
					$("#chengbao03").css("display","none");
				});
			}else{
				$("#jiantou").css("display","none");
				$("#sparks,#sparks02").unbind("hover");
				$("#chengbao03").css("display","none");
		...
		if(_scrollTop_wfc<=628 && _scrollTop_wfc>=618){
			if(($("#ball10").css("display")==="none")){// && (!!$("#featured-area ul li a img").length==false)
			//console.log("显示卡牌人物");
				$("#featured-area ul li a").html("");
				$("#01_A").append('<img src="images/people/01.png" alt="aaaaaa" />');
				$("#02_A").append('<img src="images/people/02.png" alt="aaaaaa" />');
				$("#03_A").append('<img src="images/people/03.png" alt="aaaaaa" />');
				$("#04_A").append('<img src="images/people/04.png" alt="aaaaaa" />');
				$("#05_A").append('<img src="images/people/05.png" alt="aaaaaa" />');
				$("#06_A").append('<img src="images/people/06.png" alt="aaaaaa" />');
				$("#07_A").append('<img src="images/people/07.png" alt="aaaaaa" />');
				$("#08_A").append('<img src="images/people/08.png" alt="aaaaaa" />');
				$("#09_A").append('<img src="images/people/09.png" alt="aaaaaa" />');
				$("#10_A").append('<img src="images/people/10.png" alt="aaaaaa" />');
			}
		}
		if(_scrollTop_wfc<618 && _scrollTop_wfc>=600){
			if(($("#ball10").css("display")==="block")){
				//console.log("显示卡牌位置");
			  $("#featured-area ul li a").html("");
			  $("#01_A").append('<img src="images/people/01_bg.png" alt="aaaaaa" />');
			  $("#02_A").append('<img src="images/people/02_bg.png" alt="aaaaaa" />');
			  $("#03_A").append('<img src="images/people/03_bg.png" alt="aaaaaa" />');
			  $("#04_A").append('<img src="images/people/04_bg.png" alt="aaaaaa" />');
			  $("#05_A").append('<img src="images/people/05_bg.png" alt="aaaaaa" />');
			  $("#06_A").append('<img src="images/people/06_bg.png" alt="aaaaaa" />');
			  $("#07_A").append('<img src="images/people/07_bg.png" alt="aaaaaa" />');
			  $("#08_A").append('<img src="images/people/08_bg.png" alt="aaaaaa" />');
			  $("#09_A").append('<img src="images/people/09_bg.png" alt="aaaaaa" />');
			  $("#10_A").append('<img src="images/people/10_bg.png" alt="aaaaaa" />');
			}
		}
